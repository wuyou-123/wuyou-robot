...
public class MessageDispenser {
    ...
    private final static List<String> READY_CMD_LIST = Arrays.asList("继续", "准备", "再来一把", "再来", "好了", "ok", "ready", "again");

    public static void callLandlords(String message, Map<String, Object> data) {
    ...
    public static void playerPoker(String message, Map<String, Object> data) {
        message = message.toLowerCase(Locale.ROOT);
    ...
    public static void otherMsg(String message, Map<String, Object> data) {
        message = message.toLowerCase(Locale.ROOT);
    ...
    public static void playerReady(String message, Map<String, Object> data) {
        message = message.toLowerCase(Locale.ROOT);
