...
public class Message implements Serializable {
    ...
    public Message(MsgGet msgGet) {
        if (msgGet instanceof MessageGet) {
            this.message = ((MessageGet) msgGet).getMsg();
            this.messageText = ((MessageGet) msgGet).getText();
            this.flag = ((MessageGet) msgGet).getFlag().getFlag().getId();
